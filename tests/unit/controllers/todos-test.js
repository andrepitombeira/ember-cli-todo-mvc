...
test('inflection', function() {
    ...
    equal(controller.get('inflection'), 'todos');
    ...
    equal(controller.get('inflection'), 'todo');
...
test('aggregates', function() {
   ...
   deepEqual(controller.get('completed'), 0);
   ...
   equal(controller.get('allAreDone'), false);
    ...
    deepEqual(controller.get('completed'), 1);
    ...
    deepEqual(controller.get('completed'), 2);
    equal(controller.get('hasCompleted'), true);
    equal(controller.get('allAreDone'), false);
    ...
    deepEqual(controller.get('completed'), 3);
    equal(controller.get('hasCompleted'), true);
    equal(controller.get('allAreDone'), true);
});

test('allAreGone: get', function() {
    var controller = this.subject();
    var todo1 = mock();
    var todo2 = mock();
